...
const NftPreviewCard = () => {
	return (
		<section className=' flex min-h-screen items-center justify-center bg-gray-700'>
			<div className='  mx-5 w-96  rounded-2xl bg-gray-800 p-6'>
				...
				<div className=' space-y-5 border-b-[1px] border-b-nftPreviewCard-text-gray py-5'>
					<h1 className=' cursor-pointer text-2xl font-bold text-gray-50 transition-colors duration-300 hover:text-nftPreviewCard-ethereum-blue '>Equilibrium #3429</h1>
				...
				<div className=' flex items-center justify-start space-x-4 py-5'>
					...
					<p className=' text-lg text-nftPreviewCard-text-gray'>
						Creation of <span className=' cursor-pointer text-gray-50 transition-colors duration-300 hover:text-nftPreviewCard-ethereum-blue'>Jules Wyvern</span>
					</p>
				</div>
			</div>
		</section>
